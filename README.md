...
If it possible to change this to instead use gitmoji. That is done following the [gitmoji guide](https://github.com/momocow/semantic-release-gitmoji?tab=readme-ov-file#usage).
